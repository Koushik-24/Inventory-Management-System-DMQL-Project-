...
<div class="hk-pg-header">
 <h4 class="hk-pg-title" style="color:#f0f0f0;">
<?php
$fdate=$_POST['fromdate'];
$tdate=$_POST['todate'];
?>
B/w Dates report from <?php echo $fdate?> to <?php echo $tdate?></h4>
                </div>
                <div class="row">
                    <div class="col-xl-12">
...
$query=mysqli_query($con,"select distinct InvoiceNumber,PaymentMode,InvoiceGenDate  from tblorders where date(InvoiceGenDate) between '$fdate' and '$tdate'");
$cnt=1;
...
<td>
<a href="view-invoice.php?invid=<?php echo base64_encode($row['InvoiceNumber'].$rno);?>" class="mr-25" data-toggle="tooltip" data-original-title="View Details" target="_blank">View Invoice</a>
</td>
</tr>
<?php 
$cnt++;
