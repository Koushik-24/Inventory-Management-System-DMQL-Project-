...
<h3 class="mb-35 font-weight-600">INSANE</h3>
...
<th width="10%">Price</th>
                                            ...
                                            <tbody>
<?php 
$query=mysqli_query($con,"select tblproducts.CategoryCode,tblproducts.ProductName,tblproducts.ProductPrice,tblorders.Quantity  from tblorders join tblproducts on tblproducts.ProductName=tblorders.ProductName where tblorders.InvoiceNumber='$inid'");
$cnt=1;
while($row=mysqli_fetch_array($query))
{    
?>                                                
